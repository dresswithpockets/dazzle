...
pub fn get_simple_operator_defaults() -> HashMap<&'static str, Attribute> {
    HashMap::from([
...
pub fn get_operator_defaults() -> anyhow::Result<HashMap<String, HashMap<String, pcf::Attribute>>> {
