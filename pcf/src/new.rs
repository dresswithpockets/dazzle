...
use crate::{attribute::Attribute, strings::{str_to_cstring, string_to_cstring}};
...
mod tests {
    ...
    fn converts_children() {
        ...
        assert_eq!(expected_size, computed_size, "compute_encoded_size is not computing the correct size");
    }
